...
<?php
    ...
    $count = $dbh->exec("create or replace table t (
    ...
    $tests = [
        ...
        [
            "input" => [4, "1001-01-01 00:00:00.000 +00:00"],
            "output" => [4, "1001-01-01 00:00:00.000000000 -00:00"],
        ],
        [
            "input" => [5, "1000-01-01 00:00:00.000 +00:00"],
            "output" => [5, "1000-01-01 00:00:00.000000000 -00:00"],
        ],
        [
...
C1: 4, C2: 1001-01-01 00:00:00.000000000 -00:00
C1: 5, C2: 1000-01-01 00:00:00.000000000 -00:00
