...
<?php
    ...
    $tests = [
        ...
        [
            "input" => [6, "9999-12-31 23:59:59.999999 -05:00"],
            "output" => [6, "9999-12-31 23:59:59.999999000"],
        ],
    ];
...
C1: 3, C2: 1600-01-01 00:03:58.000000000
C1: 4, C2: 1-01-01 00:03:58.000000000
C1: 5, C2: 0-01-01 00:03:58.000000000
C1: 6, C2: 9999-12-31 23:59:59.999999000
===DONE===
