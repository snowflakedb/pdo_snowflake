...
<?php
    ...
    $count = $dbh->exec(
        "create or replace table t (c1 int, c2 timestamp_ntz)");
    if ($count == 0) {
    ...
    $tests = [
        ...
        [
            "input" => [4, "1001-01-01 00:00:00.000"],
            "output" => [4, "1001-01-01 00:00:00.000000000"],
        ],
        [
            "input" => [5, "1000-01-01 00:00:00.000"],
            "output" => [5, "1000-01-01 00:00:00.000000000"],
        ],
        [
            "input" => [6, null],
            "output" => [6, null],
...
C1: 4, C2: 1001-01-01 00:00:00.000000000
C1: 5, C2: 1000-01-01 00:00:00.000000000
C1: 6, C2: 
