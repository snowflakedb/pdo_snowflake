...
if test "$PHP_PDO_SNOWFLAKE" != "no"; then
  ...
  if test "$build_mac" == "yes"; then
    ...
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/libflatbuffers.a"
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/libgflags.a"
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/libglog.a"
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/libjemalloc_pic.a"
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/liblz4.a"
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/libsnappy.a"
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/libzstd.a"
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/libbrotlidec-static.a"
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/libbrotlienc-static.a"
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/libbrotlicommon-static.a"
    LDFLAGS="$LDFLAGS -Wl,-force_load,$SNOWFLAKE_CLIENT_DIR/deps-build/darwin/arrow_deps/lib/liblzo2.a"
