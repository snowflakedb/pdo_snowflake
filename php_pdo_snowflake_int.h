...
#define PDO_SNOWFLAKE_CONN_ATTR_WIF_PROVIDER_IDX 33
#define PDO_SNOWFLAKE_CONN_ATTR_WIF_TOKEN_IDX 34
#define PDO_SNOWFLAKE_CONN_ATTR_WIF_AZURE_RESOURCE_IDX 35
