...
if [[ "$PLATFORM" == "linux" ]]; then
    ...
    g++ -shared \
        ...
        libsnowflakeclient/lib/linux/$ARCH/libsnowflakeclient.a \
        libsnowflakeclient/deps-build/linux/$ARCH/openssl/lib/libcrypto.a \
        libsnowflakeclient/deps-build/linux/$ARCH/openssl/lib/libssl.a \
        libsnowflakeclient/deps-build/linux/$ARCH/curl/lib/libcurl.a \
        libsnowflakeclient/deps-build/linux/$ARCH/oob/lib/libtelemetry.a \
        libsnowflakeclient/deps-build/linux/$ARCH/aws/lib64/libaws-cpp-sdk-core.a \
        libsnowflakeclient/deps-build/linux/$ARCH/aws/lib64/libaws-cpp-sdk-s3.a \
        libsnowflakeclient/deps-build/linux/$ARCH/azure/lib/libazure-storage-lite.a \
        libsnowflakeclient/deps-build/linux/$ARCH/uuid/lib/libuuid.a \
        libsnowflakeclient/deps-build/linux/$ARCH/arrow/lib/libarrow.a \
        libsnowflakeclient/deps-build/linux/$ARCH/arrow_deps/lib/libjemalloc_pic.a \
        libsnowflakeclient/deps-build/linux/$ARCH/boost/lib/libboost_filesystem.a \
        libsnowflakeclient/deps-build/linux/$ARCH/boost/lib/libboost_regex.a \
        libsnowflakeclient/deps-build/linux/$ARCH/boost/lib/libboost_system.a \
        -O2 \
        -Wl,--whole-archive \
        -Wl,--no-whole-archive \
        -Wl,-soname \
        ...
        libsnowflakeclient/deps-build/linux/$ARCH/openssl/lib/libssl.a \
        libsnowflakeclient/deps-build/linux/$ARCH/openssl/lib/libcrypto.a \
        libsnowflakeclient/deps-build/linux/$ARCH/cmocka/lib/libcmocka.a
